...
Cette réflexion me conduit au troisième aspect : pourquoi utiliser une fonctionnalité récente ? Un outil reste un outil, seul l'usage que l'on en fait le rend indispensable. Evidemment, _quand on n'a qu'un marteau, tout ressemble à un clou_, mais multiplier les alternatives dans l'autre-sens n'est pas une meilleure solution. J'ai vu trop de projets utiliser des API toutes neuves à peine disponibles[^justreleased] juste parce qu'elles semblaient sexy à utiliser.
